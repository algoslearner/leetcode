...
class Solution:
    def maximumImportance(self, n: int, roads: List[List[int]]) -> int:
        ...
        # cities with most roadcount should receive the most score
        roadcount.sort()
        
        # multiply roadcount with corresponding score, for each city
        totalscore = 0
        for i in range(n):
            totalscore += roadcount[i] * (i + 1)
        return totalscore
