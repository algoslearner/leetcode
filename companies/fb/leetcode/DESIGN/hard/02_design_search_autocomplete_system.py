...
###################################################################################################################
# it's a trade-off between speed and storage, but just kinda wondering how people do that in real applications?
# TRIE
...
###################################################################################################################
# it's a trade-off between speed and storage, but just kinda wondering how people do that in real applications?
# Rather than DFS, I tried storing all the words at each node, it increases space but makes the solution around 5 times faster.
